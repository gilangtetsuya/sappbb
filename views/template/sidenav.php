<div class="js-sidenav sidenav__container">
 ...
 <nav>
  <ul class="sidenav-menu">
    ...
    <li><a href="/sampel/views"><span class="fa fa-home fa-fw"></span> Dashboard</a></li>
    <li><a href="input-permohonan"><span class="fa fa-plus fa-fw"></span> Input Permohonan</a></li>
    <li>
     <a href="javascript:void(0)" id="menu-toggle-1"><span class="fa fa-list-alt fa-fw"></span> Data Berkas Permohonan <span class="caret"></span></a>
     <ul class="sidenav-sub-menu">
      <li><a href="data-berkas-permohonan?zona=1">Zona 1</a></li> 
      <li><a href="data-berkas-permohonan?zona=2">Zona 2</a></li>
      <li><a href="data-berkas-permohonan?zona=3">Zona 3</a></li>
      <li><a href="data-berkas-permohonan?zona=4">Zona 4</a></li>
     </ul>
    </li>
    ...
    <li>
     <a href="javascript:void(0)" id="menu-toggle-2"><span class="fa fa-users fa-fw"></span> Admin Menu <span class="caret"></span></a>
     <ul class="sidenav-sub-menu">
